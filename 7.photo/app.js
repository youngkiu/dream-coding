...
parser.add_argument("-p", "--photo-dir", {
  type: "str",
...
if (
  !fs.existsSync(args.photo_dir) ||
  !fs.lstatSync(args.photo_dir).isDirectory()
) {
...
fs.promises.readdir(args.photo_dir).then(processFiles).catch(console.error);
